...
import AddMainBanner_S from "../modelpopup/AddMainBanner_S";
  ...
  return (
    <div className="page-wrapper">
      <div className="content container-fluid">
        <Breadcrumbs
          maintitle="MainBanner"
          title="Main"
          subtitle="MainBanner"
          modal="#add_MainBanner_S"
          name="MainBanner"
          Linkname="/AddMainBanner_S"
        />
      ...
      <AddMainBanner_S getEventNames={getEventNames}/>
      <DeleteModal Name="Delete Social Record" />
    </div>
  );
};

export default MainBanner_S;
