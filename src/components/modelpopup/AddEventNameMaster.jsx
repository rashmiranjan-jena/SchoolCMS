...
const AddEventNameMaster = ({getEventNames}) => {
  const initialData = {
    event_name: "",
    event_id: "",
    event_description: "",
  ...
  return (
    <div id="add_EventNameMaster" className="modal custom-modal fade" role="dialog">
      <ToastContainer />
          ...
          <form ref={formRef} >
              <div className="row">
                <div className="col-6 mb-3">
                  ...
                  <input type="text" id="event_name" name="event_name" className="form-control" value={formData.event_name}
...
export default AddEventNameMaster;
