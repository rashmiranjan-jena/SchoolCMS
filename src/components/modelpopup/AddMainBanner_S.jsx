...
const AddMainBanner_S = ({getEventNames}) => {
  const initialData = {
    logo_title: "",
    // event_id: "",
    // event_description: "",
  ...
  return (
    <div id="add_MainBanner_S" className="modal custom-modal fade" role="dialog">
      <ToastContainer />
      <ImportantModal className="modal-dialog modal-lg">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title">
              <span className="text-muted fw-light">MainBanner /</span> AddMainBanner
            </h5>
            <button
              type="button"
              className="btn-close"
...
export default AddMainBanner_S;
