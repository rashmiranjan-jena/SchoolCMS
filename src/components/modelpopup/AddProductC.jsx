...
const AddProductC = ({getEventNames}) => {
  const initialData = {
    logo_title: "",
    // event_id: "",
    // event_description: "",
  ...
  return (
    <div id="add_ProductC" className="modal custom-modal fade" role="dialog">
      <ToastContainer />
      <ImportantModal className="modal-dialog modal-lg">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title">
              <span className="text-muted fw-light">Product /</span> AddProduct
            </h5>
            <button
              type="button"
              className="btn-close"
