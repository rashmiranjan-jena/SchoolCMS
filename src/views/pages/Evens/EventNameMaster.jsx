...
import AddEventNameMaster from "../../../components/modelpopup/AddEventNameMaster";
import DeleteModal from "../../../components/modelpopup/DeleteModal";
import { get,update,_delete } from "../../../utils/intercepter";
import Swal from 'sweetalert2';

const EventNameMaster = () => {
  ...
  return (
    <div className="page-wrapper">
      <div className="content container-fluid">
        <Breadcrumbs
          maintitle="EventNameMaster"
          title="Events"
          subtitle="Event Master"
          modal="#add_EventNameMaster"
          name="EventNameMaster"
          Linkname="/AddEventNameMaster"
        />
      ...
      <AddEventNameMaster getEventNames={getEventNames}/>
      <DeleteModal Name="Delete Social Record" />
    </div>
  );
};

export default EventNameMaster;
